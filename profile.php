...
?>  
    ...
    <div class="profile_left">
    	...
    	<div class="profile_name_big"><?php echo $user_array['username']; ?></div>
    		...
    		<?php
    		     ...
    		     if ($userLoggedIn != $username) {
    		     	if ($logged_in_user_obj->isFriend($username)) {
    		     		...
    		     		echo '
                            <input type="submit" name="" class="default" value="Request Sent"><br>
    		     		';
    		     	}else {
    		     		echo '
        ...
        <ul class="nav nav-tabs" role="tablist" id="profileTabs">
            <li role="presentation" class="nav-item"><a class="nav-link active" href="#newsfeed_div" aria-controls="newsfeed_div" role="tab" data-toggle="tab">Newsfeed</a></li>
            <li role="presentation" class="nav-item"><a class="nav-link" href="#messages_div" aria-controls="messages_div" role="tab" data-toggle="tab">Messages</a></li>
        </ul>
        <br>
        <div class="tab-content">
             ...
             <div role="tabpanel" class="tab-pane fade" id="messages_div">
                  <?php 
                       echo "<h4>You and <a href='".$username."'>".$profile_user_obj->getUsername()."</a></h4><hr><br>";
      ...
      <script>
     	...
     	$(document).ready(function(){
			   ...
			   $(window).scroll(function(){
                   ...
                   if (document.body.scrollHeight < (document.body.scrollTop + window.innerHeight + 1) && noMorePosts == "false") {
                   	   $('#loading').show();
