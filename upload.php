...
<div class="main_column column">
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width:99%; background-color:#FFF; position:relative; z-index:1; padding-bottom:0px;">  
	    
	         <div id="CroppingArea" style="position:center; overflow:scroll; border:0.5px #666 solid; margin:20px 20px 20px 20px;">	
	            <img src="<?=$imgSrc?>" border="0" id="jcrop_target" style="border:0.5px #990000 solid; position:relative; margin:0px 0px 0px 0px; padding:0px; " />
	        </div>
	        <hr>

	        <div id="InfoArea" style="position:relative; overflow:hidden; margin:10px 0px 0px 20px; border:0px #666 solid;">	
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; margin:10px 0px 0px 40px;" >  
	        ...
	        <div id="CropImageForm2" style="width:100px; height:30px; margin:10px 0px 0px 40px;" >  
