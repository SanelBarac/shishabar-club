<?php
    class Message{
        ...
        public function sendMessage($user_to, $body, $date) {
           if ($body != ""){
           	    $userLoggedIn = $this->user_obj->getUsername();
           	    $query = mysqli_query($this->con, "INSERT INTO messages (user_to, user_from, body, date_added, opened, viewed, deleted) VALUES ('$user_to', '$userLoggedIn', '$body', '$date', 'no', 'no', 'no')");
           } 
        }
        ...
        public function getMessages($otherUser) {
           	...
           	while($row = mysqli_fetch_array($get_messages_query)) {
	            ...
	            $data = $data . $div_top . $body . "</div><br style='line-height:35px'/>";
           	}
           	return $data;
        }
        ...
        public function getLatestMessage($userLoggedIn, $user2){
        	$details_array = array();
   		    ...
   		    $query = mysqli_query($this->con, "SELECT body, user_to, date_added FROM messages WHERE (user_to='$userLoggedIn' AND user_from='$user2') OR (user_to='$user2' AND user_from='$userLoggedIn') ORDER BY id DESC LIMIT 1");
        ...
        public function getConvos(){
           	...
           	foreach ($convos as $username) {
           		...
           		$return_string .= "<a href='messages.php?u=$username'>
           		    ...
           		    <img src='".$user_found_obj->getProfilePic()."' style='border-radius: 5px; margin-right: 5px;'><b>
           		    ".$user_found_obj->getUsername()."</b>
        ...
        public function getConvosDropdown($data, $limit){
            ...
            foreach ($convos as $username) {
                ...
                $return_string .= "<a href='messages.php?u=$username'>
                    ...
                    <b>".$user_found_obj->getUsername()."</b>
                    <span class='timestamp_smaller' id='grey'>".$latest_message_details[2]."</span>
                    <p id='grey' style='margin: 0;'>".$latest_message_details[0].$split."</p>
                    </div>
                    </a>";
