...
<div class="main_column column">
    ...
    <form action="close_account.php" method="POST">
    	<input type="submit" class="danger settings_submit" name="close_account" id="close_account" value="Yes! Close it!">
    	<input type="submit" class="info settings_submit" name="cancel" id="update_details" value="No way!">
    </form>
</div>